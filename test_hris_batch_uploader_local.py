"""
Temporary test file for Sprint 6.16 HRIS Batch Uploader.

This test uses local mock HRIS upload page.
It does not access real HRIS URL.

Run from project root:
py test_hris_batch_uploader_local.py
"""
...
TEMP_CONFIG_FILE = Path(
    r"D:\Python Project\OfficeAutomationSuite-Karina\temp\OAS-K_HRIS_Configuration_Batch_Test.xlsx"
)
...
MOCK_UPLOAD_FILE = MOCK_SITE_FOLDER / "batch_upload_local.html"
...
<head>
    <meta charset="UTF-8">
    <title>Mock HRIS Batch Upload - OAS-K</title>
    <style>
...
<body>
    <div class="card">
        ...
        <p>Local mock page for OAS-K Sprint 6.16.</p>
...
def main() -> None:
    print("=" * 80)
    print("OAS-K Sprint 6.16 HRIS Batch Uploader Local Test")
    print("=" * 80)
    ...
    try:
        ...
        result = batch_uploader.upload_batch(
    ...
    print()
    print("=" * 80)
    print("HRIS Batch Uploader local test finished.")
    print("=" * 80)
