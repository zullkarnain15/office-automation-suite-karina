"""
Temporary test file for Sprint 6.17 HRIS Batch Artifact Update.

Run from project root:
py test_hris_batch_artifact_update.py
"""
...
TEMP_CONFIG_FILE = Path(
    r"D:\Python Project\OfficeAutomationSuite-Karina\temp\OAS-K_HRIS_Configuration_Artifact_Update_Test.xlsx"
)
...
MOCK_UPLOAD_FILE = MOCK_SITE_FOLDER / "artifact_update_local.html"
...
<head>
    <meta charset="UTF-8">
    <title>Mock HRIS Batch Artifact Update - OAS-K</title>
    <style>
...
def main() -> None:
    print("=" * 80)
    print("OAS-K Sprint 6.17 HRIS Batch Artifact Update Test")
    print("=" * 80)
    ...
    print()
    print("=" * 80)
    print("HRIS Batch Artifact Update test finished.")
    print("=" * 80)
